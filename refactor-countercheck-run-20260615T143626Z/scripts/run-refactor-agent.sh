...
PROMPT="$RUN_DIR/prompts/refactor-agent.md"
LAST_MESSAGE="$RUN_DIR/logs/run-refactor-agent-last-message.md"
EVENTS="$RUN_DIR/logs/run-refactor-agent-events.jsonl"
